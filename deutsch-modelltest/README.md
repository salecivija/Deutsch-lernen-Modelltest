...
- Interaktiver B1-Bereich zu Werte- und Orientierungswissen mit mehreren Modelltests und `Alle Fragen` ohne Punktebewertung
...
- Interactive B1 Werte- und Orientierungswissen area with several model tests and `Alle Fragen` without point scoring
